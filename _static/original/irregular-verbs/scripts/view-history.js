...
import {
  HistoryManager,
  QuizManager,
} from "../../irregular-verbs/scripts/quizmanager.js";
...
const viewHistoryByWords = () => {
  if (historyManager.questionLength === 0) {
    $historyTable.innerHTML = `<td colspan="4" style="opacity: 0.6;">学習記録がありません。<br /><a href="/_static/original/irregular-verbs/index.htmllearn.html">さぁ あなたも始めましょう!!</a></td>`;
    return;
  }
